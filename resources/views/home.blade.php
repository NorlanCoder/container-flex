...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="topbar-wraper">
                    <div class="d-none d-xl-block flex-shrink-0">
                        <ul class="tf-social-icon topbar-left">
                            <li><a href="" class="social-item social-facebook"><i
                                        class="icon icon-fb"></i></a></li>
                            <li><a href="" class="social-item social-instagram"><i
                                        class="icon icon-instagram"></i></a>
                            </li>
                            <li><a href="" class="social-item social-x"><i class="icon icon-x"></i></a>
                            </li>
                            <li><a href="" class="social-item social-snapchat"><i
                    ...
                    <div class="overflow-hidden">
                        <div class="topbar-center marquee-wrapper">
                            <div class="initial-child-container">
                                ...
                                <div class="marquee-child-item"><span class="dot"></span></div>
                                <div class="marquee-child-item">
                                    <p>Product Quality & Offerings</p>
                                </div>
                                <div class="marquee-child-item"><span class="dot"></span></div>
                                <!-- 3 -->
                                <div class="marquee-child-item">
                                    <p>Personalization & Marketing</p>
                                </div>
                                <div class="marquee-child-item"><span class="dot"></span></div>
                                <div class="marquee-child-item">
                                    <p>Environmental & Ethical Commitment</p>
                                </div>
                                <div class="marquee-child-item"><span class="dot"></span></div>
                            </div>
                        </div>
                        ...
                        <div class="topbar-right">
                            <div class="tf-currencies">
                                <select class="image-select center style-default type-currencies">
                                    <option data-thumbnail=""> (EUR €)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row wrapper-header align-items-center">
                        ...
                        <div class="col-xl-3 col-md-4 col-6">
                            <a href="home-furniture.html" class="logo-header">
                ...
                <div class="container">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-menu">
                            ...
                            <li class="menu-item">
                                <a href="" class="item-link">Our achievements</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <!-- /Header -->
        <!-- Slider -->
        <section class="tf-slideshow slider-furniture slider-style-2">
            <div class="swiper tf-sw-slideshow slider-effect-fade" data-preview="1" data-tablet="1" data-mobile="1"
                data-centered="false" data-space="0" data-space-mb="0" data-loop="true" data-effect="fade"
                data-auto-play="true">
                <div class="swiper-wrapper">
                                ...
                                <div class="container">
                                    <div class="content-slider text-center">
                                        <div class="box-title-slider">
                                            <h2 class="heading letter-0 text-white fw-medium fade-item fade-item-1">
                                                Transform Every <br> Space
                                            </h2>
                                            <p class="sub text-white text-md text-line-clamp-1 fade-item fade-item-2">
                                                Discover our latest container solutions with unbeatable deals.
                                            </p>
                                        </div>
                            ...
                            <div class="box-content-left">
                                <div class="container">
                                    <div class="content-slider text-center">
                                        <div class="box-title-slider">
                                            <h2 class="heading letter-0 text-white fw-medium fade-item fade-item-1">
                                                Upgrade Your <br> Space
                                            </h2>
                                            <p class="sub text-white text-md text-line-clamp-1 fade-item fade-item-2">
                                                Find the perfect container at the best price—shop now.
                                            </p>
                                        </div>
                                        <div class="box-btn-slider fade-item fade-item-3">
                                            <a href="{{route('productlist')}}" class="tf-btn btn-out-line-white">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-wrap">
                            <div class="box-content-left text-center">
                                <div class="container">
                                    <div class="content-slider">
                                        <div class="box-title-slider">
                                            <h2 class="text-white letter-0 fw-medium fade-item fade-item-1">
                                                Innovate with <br> Containers
                                            </h2>
                                            <p class="sub text-white text-md text-line-clamp-1 fade-item fade-item-2">
                                                Durable, affordable, and ready for any project. Explore our collection today.
                                            </p>
                                        </div>
                                        <div class="box-btn-slider fade-item fade-item-3">
                                            <a href="{{route('productlist')}}" class="tf-btn btn-out-line-white">
                ...
                <div class="wrap-pagination">
                    <div class="container">
                        <div class="sw-dots style-white sw-pagination-slider justify-content-center"></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div dir="ltr" class="swiper tf-swiper" data-swiper='{
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="tf-icon-box style-lg wow fadeInLeft" data-wow-delay="0.1s">
                                ...
                                <div class="content">
                                    <div class="title text-uppercase">Transparency</div>
                                    <p>Clear information on pricing</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tf-icon-box style-lg wow fadeInLeft" data-wow-delay="0.2s">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    xmlns="../www.w3.org/2000/svg.html">
                                    <path
                                ...
                                <div class="content">
                                    <div class="title text-uppercase">Support Online</div>
        ...
        <section class="flat-spacing-3 pt-0">
            <div class="container">
                <div class="flat-title wow fadeInUp">
                    <h4 class="title">Top Containers You'll Love</h4>
                    <p class="desc text-main text-md">Discover our best-selling containers that customers trust for every need</p>
                </div>
        ...
        <div class="flat-spacing-9 pt-5">
            <div class="container">
                <div class="wrapper-thumbs-tes flat-thumbs-tes" data-effect="fade">
                    <div class="box-left">
                        <div dir="ltr" class="swiper tf-thumb-tes" data-space-lg="0" data-space="0">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-sw-thumb">
                                        <img class="lazyload" data-src="images/testimonial/tes-furniture1.jpg"
                                            src="images/testimonial/tes-furniture1.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-sw-thumb">
                                        <img class="lazyload" data-src="images/testimonial/tes-furniture2.jpg"
                                            src="images/testimonial/tes-furniture2.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="box-testimonial-main">
                                        <span class="quote text-white icon-quote"></span>
                                        <div class="content">
                                            ...
                                            <div class="title-review text-white">Elegance and Comfort Combined</div>
                                            <p class="text-review display-xs text-white">"I recently purchased a sofa
                                                from this store, and it has completely transformed my living room. The
                                                quality is outstanding, and the design fits perfectly with my style.
                                                Highly recommend!"</p>
                                            <div class="box-author">
                                                <div class="img d-md-none">
                                                    <img src="images/testimonial/tes-furniture1.jpg" alt="author">
                                                </div>
                                                <div class="info">
                                ...
                                <div class="swiper-slide">
                                    <div class="box-testimonial-main">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="title-review text-white">Elegance and Comfort Combined</div>
                                            <p class="text-review display-xs text-white">I just got a coffee table from
                                                this store, and it’s absolutely perfect for my space. The design is
                                                stylish, the quality is top-notch, and it adds a cozy touch to my living
                                                room. Definitely worth it!</p>
                                            <div class="box-author">
                                                <div class="img d-md-none">
                                                    <img src="images/testimonial/tes-furniture2.jpg" alt="author">
                                                </div>
                                                <div class="info">
                                        ...
                                        <div class="card-product">
                                            <div class="card-product-wrapper">
                                                ...
                                                <div class="on-sale-wrap"><span
                                                        class="on-sale-item trending">Trending</span>
                                                </div>
                                                <ul class="list-product-btn">
                                                    <li>
                                                        <a href="#shoppingCart" data-bs-toggle="offcanvas"
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" data-color="black">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/furniture/nightstand-black.jpg"
                                        src="images/products/furniture/nightstand-black.jpg" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner">
                        <div class="tf-product-info-heading">
                            ...
                            <p class="text">The Nook Nightstand is a compact wooden bedside table with a drawer and an
                                open shelf, offering both storage and style. Its minimalist design suits any bedroom.
                            </p>
                        </div>
                        <div class="tf-product-info-variant">
                            <div class="variant-picker-item variant-color">
                                <div class="variant-picker-label">
                                    Color:<span class="variant-picker-label-value value-currentColor">Brown</span>
                                </div>
                                <div class="variant-picker-values">
                                    <div class="hover-tooltip color-btn active" data-color="brown">
                                        <span class="check-color bg-brown-7"></span>
                                        <span class="tooltip">Brown</span>
                                    </div>
                        ...
                        <div class="tf-compare-list">
                            <div class="tf-compare-item file-delete">
                                ...
                                <div class="content">
                                    ...
                                    <p class="price-wrap">
                                        <span class="new-price text-primary">$150.00</span>
                                        <span class="old-price text-decoration-line-through text-dark-1">$170.00</span>
                                    </p>
                                </div>
                            </div>
                            <div class="tf-compare-item file-delete">
