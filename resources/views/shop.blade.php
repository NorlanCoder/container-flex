            ...
            <div class="container">
                ...
                <div class="wrapper-control-shop">
                                ...
                                <div class="info-list">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch line active">
                                            <span class="d-none color-filter">White</span>
                                            <span class="swatch-value bg-white"></span>
                                            <img class="lazyload" data-src="images/products/fashion/product-17.jpg"
                                                src="images/products/fashion/product-17.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="d-none color-filter">Dark Green</span>
                                            <span class="swatch-value bg-dark-green"></span>
                                ...
                                <div class="info-list">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch hover-tooltip tooltip-bot active">
                                            <span class="d-none tooltip color-filter">Grey</span>
                                            <span class="swatch-value bg-grey-4"></span>
                                        ...
                                        <li class="list-color-item color-swatch">
                                            <span class="d-none color-filter">Light Grey</span>
                        ...
                        <div class="card-product style-list" data-availability="Out of stock" data-brand="Zotac">
                            ...
                            <div class="card-product-info">
                                <div class="info-list">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="d-none color-filter">Light Orange</span>
                        ...
                        <div class="card-product style-list" data-availability="Out of stock" data-brand="Zotac">
                            ...
                            <div class="card-product-info">
                                <div class="info-list">
                                    ...
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch hover-tooltip tooltip-bot active">
                                            <span class="d-none tooltip color-filter">Light Pink</span>
                    ...
                    <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                        ...
                        <!-- Card Product 2 -->
                        <div class="card-product grid style-1 out-of-stock" data-availability="Out of stock"
                            data-brand="Zotac">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- Card Product 15 -->
                        <div class="card-product grid style-1 card-product-size" data-availability="Out of stock"
                            data-brand="Zotac">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
