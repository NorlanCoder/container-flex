            ...
            <form action="{{ route('category.update',$category->id) }}" enctype="multipart/form-data" class="w-full"
                ...
                <div class="flex flex-col w-1/2 mt-4">
                    ...
                    <input type="text"
                        ...
                        placeholder="Saisir Libellé" name="label" value="{{ $category->label }}" id="libelle">
                </div>
                <div class="flex flex-col w-1/2 mt-4">
                    <label for="equipe1" class="text-black dark:text-white mb-2">Description</label>
                    <input type="text"
                        class="w-full border border-[#444] bg-transparent text-black  p-2"
                        placeholder="Saisir description" name="description" value="{{ $category->description }}" id="description">
                </div>
                <div class="mt-4">
                    <button type="submit" class="bg-[#444] text-white p-2 px-4">Modifier</button>
                </div>
            </form>
        </div>
