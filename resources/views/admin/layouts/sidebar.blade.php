...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a href="#" class="flex justify-center">
            <div class="flex justify-center w-3/4 p-5 bg-[#444] dark:bg-gray-800 rounded-full">
                <img src="{{ asset('auth/src/assets/Logo_Signal_blanc.png') }}" alt="logo light"
                    class="max-h-12 block dark:hidden">
                <img src="{{ asset('auth/src/assets/Logo_fidIn.png') }}" alt="logo light"
                    class="max-h-12  hidden dark:block">
            </div>
        </a>
