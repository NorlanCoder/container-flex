...
<div class="container px-6 mx-auto grid">
    ...
    <div class="w-full flex justify-between">
        ...
        <a href="{{route('souscategory.create')}}" class="text-gray-600 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Creer une sous-categorie</a>
    </div>
